              ...
              <div class="card-body">
                  <?php
                    ...
                    if(mysqli_num_rows($result) > 0) {
                      ...
                      <div id="no-data">
                        <center>
                          <img src="https://img.freepik.com/premium-vector/no-data-concept-illustration_203587-28.jpg?w=2000" height="400" width="400"/>
                          <center><h5>No Data please click on new to create the exam</h5></center>
                        </center>
                      </div>
                      <?php
                    }
